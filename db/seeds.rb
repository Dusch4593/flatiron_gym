...
exercise2 = Exercise.create(name: "Jumping Jacks", exercise_type: "Jump", description: "jump with the legs spread wide and the hands going overhead", sets: 2, reps: 15, routine_id: morning_routine.id)
...
exercise2 = Exercise.create(name: "Sit-ups", exercise_type: "Abdominal", description: "works the abdomin; similar to crunches but works some extra muscles", sets: 3, reps: 15, routine_id: afternoon_routine.id)
...
exercise2 = Exercise.create(name: "Jumping Jacks", exercise_type: "Jump", description: "jump with the legs spread wide and the hands going overhead", sets: 2, reps: 15, routine_id: evening_routine.id)
...
exercise2 = Exercise.create(name: "Jumping Jacks", exercise_type: "Jump", description: "jump with the legs spread wide and the hands going overhead", sets: 2, reps: 15, routine_id: late_night_routine.id)
